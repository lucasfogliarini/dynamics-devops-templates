function Check-NewEnvironmentVariables {
    ...
    if(Test-Path -Path "./$Repo/$SolutionName/environmentvariabledefinitions"){
        ...
        foreach ($folder in $folders){
            ...
            if ($matchesSchemaNameQA.Count -lt 1) {
            ...
            # Se a variável não estiver no arquivo incluir
            if ($matchesSchemaNameHml.Count -lt 1) {
            ...
            # Se a variável não estiver no arquivo incluir
            if ($matchesSchemaNameProd.Count -lt 1) {
        ...
        Write-Host "Nenhuma definicao de variavel foi encontrada no sistema de arquivos."
    }
...
function Remove-EnvironmentVariablesValues {
    ...
    if(Test-Path -Path "./$Repo/$SolutionName/environmentvariabledefinitions"){
        ...
        Write-Host "Nenhuma valor de variavel foi encontrada no sistema de arquivos."
    }
